...
build-$1: $(stamps_dir)/built-$1

ifneq (,$$(filter $$(from_$1),$(from_library)))
# Found in this lib
$(stamps_dir)/built-$1: $(stamps_dir)/built-$$(from_$1) $$(dockerfile_$1) | checkdirs
else
# Not found in this lib, so pull it first.
$(stamps_dir)/built-$1: $(stamps_dir)/pulled-$$(from_$1) $$(dockerfile_$1) | checkdirs
endif
	@echo 'Building $1...'
	@$(DOCKER_BUILD) \
		-t $$(imagename_$1):$$(imagetag_$1) \
		...
		$(lib_dir)/$$(imagename_$1)/$$(imagetag_$1) # dockerfile context (its folder's name)
	@touch $$@

build_targets+= $(stamps_dir)/built-$1
